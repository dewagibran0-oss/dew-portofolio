...
const MarqueeRow = ({ items, direction = "left", speed = 50 }: { items: Skill[], direction?: "left" | "right", speed?: number }) => (
  <div className="flex w-full overflow-hidden py-6 select-none border-y border-white/[0.02]">
    <motion.div 
