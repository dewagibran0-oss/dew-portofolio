...
/**
 * Bagian WebGL berat (Three.js ~880KB) diisolasi di file ini agar bisa
 * di-`dynamic import` HANYA saat mode heavy (desktop bertenaga).
 * Mobile / reduced-motion / mode terang TIDAK pernah mengunduh chunk ini.
 */
export default function HeroCanvas({ active }: { active: boolean }) {
  return (
    <div className="fixed inset-0 z-0 bg-[var(--bg)] overflow-hidden">
      <Canvas
